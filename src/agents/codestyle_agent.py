...
PROMPT = (
    ...
    "Для КАЖДОЙ строки НОВОЙ версии проверь ВСЕ правила. Не останавливайся на первом совпадении."
    "Если одна строка нарушает несколько правил верни верни один объект с описанием всех нарушений"
    "Правила ответа:\n"
    ...
    "Провеь что у тебя нет одинаковых line_match, если есть то объедини их в один объект"
